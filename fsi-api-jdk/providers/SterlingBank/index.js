...
var interbankNameEnquiry = function (secretKey, body, header) { return __awaiter(void 0, void 0, void 0, function () {
    var url;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = providerPrefix + 'TransferAPIs/api/Spay/InterbankNameEnquiry';
                return [4 /*yield*/, (0, rest_1.default)(url, 'GET', secretKey, body, header)];
