...
var customerWalletBalance = function (secretKey, body, header) {
    ...
    return (0, rest_1.default)(url, Constants_1.Methods.GET, secretKey, body, header);
};
...
var newWallet = function (secretKey, body, header) {
    ...
    return (0, rest_1.default)(url, Constants_1.Methods.POST, secretKey, body, header);
};
exports.newWallet = newWallet;
var walletStatus = function (secretKey, body, header) {
    var url = providerPrefix + 'Customerwallet/Status';
    return (0, rest_1.default)(url, Constants_1.Methods.PUT, secretKey, body, header);
};
